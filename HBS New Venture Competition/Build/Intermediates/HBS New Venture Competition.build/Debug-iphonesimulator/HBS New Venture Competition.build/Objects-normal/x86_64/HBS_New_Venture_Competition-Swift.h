...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified notesBtn;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified websiteBtn;
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified toImageConstraint;
- (void)viewDidLoad;
...
@property (nonatomic, weak) IBOutlet VerificationCodeView * _Null_unspecified verificationCodeView;
- (void)viewDidLoad;
...
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified toSubHeaderConstraint;
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
- (void)viewDidLoad;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC27HBS_New_Venture_Competition7NotesVC")
