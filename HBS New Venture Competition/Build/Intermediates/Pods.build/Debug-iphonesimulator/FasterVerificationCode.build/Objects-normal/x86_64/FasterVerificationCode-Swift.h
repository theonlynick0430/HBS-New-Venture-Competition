...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FasterVerificationCode",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22FasterVerificationCode21VerificationCodeLabel")
@interface VerificationCodeLabel : UILabel
@property (nonatomic, strong) UIColor * _Nonnull borderColor;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init:(CGRect)frame isBordered:(BOOL)isBordered borderColor:(UIColor * _Nonnull)borderColor borderHeight:(CGFloat)borderHeight tintColor:(UIColor * _Nonnull)tintColor backgroundColor:(UIColor * _Nonnull)backgroundColor;
- (void)layoutSubviews;
@end


SWIFT_CLASS("_TtC22FasterVerificationCode25VerificationCodeTextField")
...
SWIFT_CLASS("_TtC22FasterVerificationCode20VerificationCodeView")
@interface VerificationCodeView : UIView
/// True if VerificationCodeLabels have to show bottom border
@property (nonatomic) BOOL labelHasBorder;
/// The VerificationCodeLabel border heigth
@property (nonatomic) CGFloat borderHeigth;
/// The VerificationCodeLabel border color
@property (nonatomic, strong) UIColor * _Nonnull labelBorderColor;
/// The VerificationCodeLabel border color in case of error
@property (nonatomic, strong) UIColor * _Nonnull labelErrorColor;
...
@property (nonatomic) BOOL focusOnLoad;
@property (nonatomic, weak) id <VerificationCodeViewDelegate> _Nullable delegate;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)awakeFromNib;
/// The initialization method that size the view and add the labels
/// \param numberOfLabel the number of label to be shown
///
- (void)setLabelNumber:(NSInteger)numberOfLabel;
@end


@interface VerificationCodeView (SWIFT_EXTENSION(FasterVerificationCode)) <UITextFieldDelegate>
...
SWIFT_PROTOCOL("_TtP22FasterVerificationCode28VerificationCodeViewDelegate_")
@protocol VerificationCodeViewDelegate
